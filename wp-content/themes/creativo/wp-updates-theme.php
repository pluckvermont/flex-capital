...
new WPUpdatesThemeUpdater_398( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_398') ) {
    class WPUpdatesThemeUpdater_398 {
