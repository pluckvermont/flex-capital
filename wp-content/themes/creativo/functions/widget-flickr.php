...
class Flickr_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		if($screen_name && $number && $api) { 
			if($imgsize =='medium') { $imgsize = '90px'; }
			elseif($imgsize =='large') { $imgsize = '135px'; }
			else { $imgsize = '53px'; }			
		?>
		...
		function jsonFlickrApi(rsp) {
			...
			for (var i=0; i < rsp.photos.photo.length; i++) {
				...
				photo.title + '"src="' + t_url + '" width="<?php echo $imgsize; ?>" height="<?php echo $imgsize; ?>"/>' + '</a></div>';
			}
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo $this->get_field_id('imgsize'); ?>"><?php _e('Image Size:','Creativo');?></label>
			<select id="<?php echo $this->get_field_id('imgsize'); ?>" name="<?php echo $this->get_field_name('imgsize'); ?>" class="widefat" style="width:100%;">
			    <option <?php selected( $instance['imgsize'], 'small'); ?> value="small"><?php _e('Small','Creativo');?></option>
			    <option <?php selected( $instance['imgsize'], 'medium'); ?> value="medium"><?php _e('Medium','Creativo');?></option> 
			    <option <?php selected( $instance['imgsize'], 'large'); ?> value="large"><?php _e('Large','Creativo');?></option>   
			</select>
		</p>
