		...
		<?php foreach ( $downloads as $download ) : ?>
			<li>
				<?php
					...
					echo apply_filters( 'woocommerce_available_download_link', '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce_orders">' . $download['download_name'] . '</a>', $download );
