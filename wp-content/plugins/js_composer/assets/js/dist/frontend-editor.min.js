...
function vc_convert_column_span_size(width) {
    return width = width.replace(/^vc_/, ""), "span12" === width ? "1/1" : "span11" === width ? "11/12" : "span10" === width ? "5/6" : "span9" === width ? "3/4" : "span8" === width ? "2/3" : "span7" === width ? "7/12" : "span6" === width ? "1/2" : "span5" === width ? "5/12" : "span4" === width ? "1/3" : "span3" === width ? "1/4" : "span2" === width ? "1/6" : "span1" === width ? "1/12" : !1
}
...
function vcGridFilterExcludeCallBack() {
    ...
    return $filterBy = $(".wpb_vc_param_value[name=filter_source]", this.$content), defaultValue = $filterBy.val(), $exclude = $(".wpb_vc_param_value[name=exclude_filter]", this.$content), autocomplete = $exclude.data("vc-param-object"), void 0 === autocomplete ? !1 : void $filterBy.change(function() {
        var $this = $(this);
...
function vcAddShortcodeDefaultParams(model) {
    ...
    params = _.extend({}, vc.getDefaults(model.get("shortcode")), params), model.set({
        params: params
    }, {
        silent: !0
    })
...
function vcEscapeHtml(text) {
    ...
    return null === text || "undefined" == typeof text ? "" : text.replace(/[&<>"']/g, function(m) {
        return map[m]
    })
}
...
if (function() {
        ...
        TabsLine = function(element, options) {
            ...
            return _this.tabs = [], _this.dropdownTabs = [], _this.$element.find(_this.options.tabSelector).each(function() {
                ...
                "undefined" == typeof el.$tab.data("tabClickSet") && (el.$tab.on("click", $.proxy(_this.options.onTabClick, el.$tab)), el.$tab.data("tabClickSet", !0))
            ...
            for (var tabsCount = this.tabs.length, i = tabsCount - 1; i >= 0; i--) {
                if (!(0 > this.getFreeSpace())) return this;
                this.moveLastToDropdown()
            }
            return this
        }, TabsLine.prototype.moveDropdownToTabs = function() {
            for (var dropdownTabsCount = this.dropdownTabs.length, i = 0; dropdownTabsCount > i; i++) {
            ...
            $devInfoBlock.length && (this.$devBlock = $devInfoBlock), "undefined" == typeof this.$devBlock && (this.$devBlock = $('<div id="vc-ui-tabs-line-dev-info" />').css({
                position: "fixed",
                right: "40px",
                top: "40px",
                padding: "7px 12px",
                ...
                "font-size": "12px",
                "z-index": 1100
            }), this.$devBlock.appendTo("body")), "undefined" == typeof this.$devInfo && (this.$devInfo = $("<div />").css({
                "margin-bottom": "7px",
                "padding-bottom": "7px",
...
}(_, Backbone, vc), _.isUndefined(window.vc) && (window.vc = {}), "undefined" == typeof window.setCookie && (window.setCookie = function(c_name, value, exdays) {
        var exdate = new Date;
        exdate.setDate(exdate.getDate() + exdays);
        var c_value = encodeURIComponent(value) + (null === exdays ? "" : "; expires=" + exdate.toUTCString());
        document.cookie = c_name + "=" + c_value
    }), "undefined" == typeof window.getCookie && (window.getCookie = function(c_name) {
        var i, x, y, ARRcookies = document.cookie.split(";");
        for (i = 0; i < ARRcookies.length; i++)
            if (x = ARRcookies[i].substr(0, ARRcookies[i].indexOf("=")), y = ARRcookies[i].substr(ARRcookies[i].indexOf("=") + 1), x = x.replace(/^\s+|\s+$/g, ""), x == c_name) return decodeURIComponent(y)
    }),
    function($) {
...
if (vc.memoizeWrapper = function(func, resolver) {
        ...
        function previewFilter(attachmentId) {
            ...
            }) : ($preview.attr("src", $preview.data("original-src")), void $previewContainer.removeClass("loading"))) : void 0
        }
        ...
        attachmentCompatRender = _.extend(media.view.AttachmentCompat.prototype.render), media.view.AttachmentCompat.prototype.render = function() {
            ...
            add: function(id, options) {
                ...
                return workflow ? workflow : workflows[id] ? workflows[id] : workflow = workflows[id] = new media.view.MediaFrame.VcGallery(_.defaults(options || {}, {
                    state: "vc_gallery",
                    title: l10n.add_images,
                    library: {
                        type: "image"
            ...
            init: function() {
                $("body").unbind("click.vcGalleryWidget").on("click.vcGalleryWidget", ".gallery_widget_add_images", function(event) {
                    ...
                    return media.vc_editor.$vc_editor_element = $(this), "true" === $this.attr("use-single") ? void media.VcSingleImage.frame(this).open("vc_editor") : ($this.blur(), void media.vc_editor.open(editor))
                })
            }
            ...
            function finishImageProcessing(newAttachments) {
                ...
                }), "undefined" == typeof type && (type = ""), type) {
                    case "gallery":
            ...
            var id;
            id = $(this).data("vcPreviewImageFilter"), "undefined" == typeof window.vc_selectedFilters && (window.vc_selectedFilters = {}), window.vc_selectedFilters[id] = $(this).val(), previewFilter(id)
        })
...
if (window.vc.filters = {
        ...
        window.init_textarea_html = function($element) {
            ...
            var data = _.isObject(loop) && !_.isUndefined(loop[key]) ? loop[key] : "",
                template = vc.template($("#_vcl-" + template_name).html(), vc.templateOptions.custom);
            return template({
                name: key,
                data: data,
                settings: settings
            ...
            setFocus: function(e) {
                e.preventDefault();
                var $target = $(e.target);
                $target.hasClass(this.options.css_class) && this.$el.trigger("focus")
            },
        ...
        var VcLoopEditorView = Backbone.View.extend({
            ...
            VcLoop = Backbone.View.extend({
                ...
                showEditor: function(e) {
                    return e.preventDefault(), _.isObject(this.loop_editor_view) ? (this.loop_editor_view.toggle(), !1) : void $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: window.ajaxurl,
                        data: {
            ...
            init: function() {
                ...
                for (var i in selected_data) {
                    var control_settings = selected_data[i].split("|"),
                        $control = control_settings.length ? this.$toolbar.find("[data-element=" + decodeURIComponent(control_settings[0]) + "]") : !1;
        ...
        var GoogleFonts = Backbone.View.extend({
            ...
            VC_AutoComplete = Backbone.View.extend({
                ...
                resize: function() {
                    var position = this.$el_wrap.position(),
                        block_position = this.$block.position(),
                        widget = this.$el.autocomplete("widget");
                ...
                focus: function(event, ui) {
                    return this.options.replace_values_on_select ? void 0 : (event.preventDefault(), !1)
                },
                ...
                createBox: function(item) {
                    ...
                    this.updateItems(), $label = $('<li class="vc_autocomplete-label vc_data" data-index="' + index + '" data-value="' + item.value + '" data-label="' + item.label + '"><span class="vc_autocomplete-label"><a>' + item.label + "</a></span>" + remove + "</li>"), $label.insertBefore(this.$el_wrap), this.labelRemoveHook($label)
                },
                ...
                labelRemoveClick: function(e, ui) {
                    ...
                    var $label = $(e.currentTarget),
                        index = parseInt($label.data("index"), 10),
                        $target = $(e.target);
                    return $target.is(".vc_autocomplete-remove") ? (this.selected_items.splice(index, 1), $label.remove(), this.updateItems(), this.$el.show(), !1) : void 0
                },
            ...
            VC_ParamGroup = Backbone.View.extend({
                ...
                addNew: function(ev) {
                    if (ev.preventDefault(), this.addAllowed()) {
                        var $newEl, fn;
                        if ("undefined" != typeof this.options.param.callbacks && "undefined" != typeof this.options.param.callbacks.before_add && (fn = window[this.options.param.callbacks.before_add], "function" == typeof fn && !fn())) return;
            ...
            VC_ParamGroup_Param = Backbone.View.extend({
                ...
                deleteParam: function(ev) {
                    ...
                    !0 === answer && (this.options.parent.items--, this.options.parent.afterDelete(), this.$el.remove(), this.unbind(), this.remove())
                },
                content: function() {
                    return this.$content
                },
                ...
                toggle: function(ev) {
                    ...
                    $elem.slideToggle(), $parent.toggleClass("vc_param_group-collapsed").siblings(":not(.vc_param_group-collapsed)").addClass("vc_param_group-collapsed").find("> .wpb_element_wrapper").slideUp()
                }
            });
        window.i18nLocale;
        vc.edit_form_callbacks = [], vc.atts = {
            ...
            init: function(param, $field) {
                $(".wpb_vc_param_value.dropdown", $field).change(function() {
                    ...
                    option_class = option_class.replace("#", "hash-"), "undefined" != typeof prev_option_class && $this.removeClass(prev_option_class), "undefined" != typeof option_class && $this.data("option", option_class) && $this.addClass(option_class)
                })
            },
            defaults: function(param) {
                var values;
            ...
            parse: function(param) {
                var $field = this.content().find(".wpb_vc_param_value[name=" + param.param_name + "]"),
                    $block = $field.parent(),
                    val = $block.find(".vc-iconpicker").val();
                return val
            },
            init: function(param, $field) {
            ...
            parse: function() {
                var value = "vc_gid:" + (Date.now() + "-" + this.model.get("id") + "-" + Math.floor(11 * Math.random()));
                return value
            }
        ...
        _.isUndefined(window.vc) && (window.vc = {}), vc.ShortcodesBuilder = function(models) {
            ...
            buildFromTemplate: function(html, data) {
                ...
                return templateShortcodesHasId = !1, _.each($(html), function(block) {
                    ...
                    shortcode = JSON.parse(decodeURIComponent(encoded_shortcode + "")), $block = vc.$page.find("[data-model-id=" + shortcode.id + "]"), params = _.isObject(shortcode.attrs) ? shortcode.attrs : {}, templateShortcodesHasId || (id_param = vc.shortcodeHasIdParam(shortcode.tag), id_param && !_.isUndefined(params) && !_.isUndefined(params[id_param.param_name]) && 0 < params[id_param.param_name].length && (templateShortcodesHasId = !0)), model = vc.shortcodes.create({
                        id: shortcode.id,
                        shortcode: shortcode.tag,
                        params: this.unescapeParams(params),
                        parent_id: shortcode.parent_id,
            ...
            parse: function(data, content, parent) {
                ...
                return _.isNull(matches) ? data : (_.each(matches, function(raw) {
                    ...
                    _.each(atts_raw.named, function(value, key) {
                        ...
                        parent_id: _.isObject(parent) ? parent.id : !1
        ...
        _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function() {
            ...
            return this.active_panel ? void(model && vc.active_panel.model && vc.active_panel.model.get("id") === model.get("id") ? (vc.active_panel.model = null, this.active_panel.hide()) : model || (vc.active_panel.model = null, this.active_panel.hide())) : !1
            ...
            buildFiltering: function() {
                ...
                var mapped = vc.getMapped(tag),
                    as_parent = tag && !_.isUndefined(mapped.as_parent) ? mapped.as_parent : !1;
            ...
            createElement: function(e) {
                var $control, tag, row_params, column_params, row_inner_params, _this, shortcode, i;
                if (!this.preventDoubleExecution) {
                    this.preventDoubleExecution = !0, this.do_render = !0, e.preventDefault(), $control = $(e.currentTarget), tag = $control.data("tag"), row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), row_inner_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row_inner && (row_inner_params = _.extend(row_inner_params, window.vc_settings_presets.vc_row_inner)), column_params = {
                        width: "1/1"
                    }, "undefined" != typeof window.vc_settings_presets.vc_column && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column)), !1 === this.model && "vc_row" !== tag ? (this.builder.create({
                        shortcode: "vc_row",
                        params: row_params
                    }).create({
                        shortcode: "vc_column",
                    ...
                    for (this.builder.create(params), i = this.builder.models.length - 1; i >= 0; i--) shortcode = this.builder.models[i].get("shortcode"), "undefined" != typeof window.vc_settings_presets[shortcode] && (this.builder.models[i].attributes.params = _.extend(this.builder.models[i].attributes.params, window.vc_settings_presets[shortcode]));
                    "vc_row" === tag ? this.builder.create({
                        ...
                        width: "1/1"
                    }, "undefined" != typeof window.vc_settings_presets.vc_column_inner && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column_inner)), this.builder.create({
            ...
            render: function(model, prepend) {
                return this.prepend = _.isBoolean(prepend) ? prepend : !1, this.place_after_id = _.isString(prepend) ? prepend : !1, this.model = _.isObject(model) ? model : !1, this.$content = this.$el.find('[data-vc-ui-element="panel-add-element-list"]'), this.$buttons = $('[data-vc-ui-element="add-element-button"]', this.$content), vc.AddElementBlockView.__super__.render.call(this)
            },
            createElement: function(e) {
                ...
                if (!this.preventDoubleExecution) {
                    ...
                    row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), column_params = {
                        width: "1/1"
                    }, "undefined" != typeof window.vc_settings_presets.vc_column && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column)), !1 === this.model ? (row = vc.shortcodes.create({
                        shortcode: "vc_row",
                        params: row_params
                        ...
                        parent_id: column.id,
                        root_id: row.id
                    }) : row) : "vc_row" === tag ? (row_inner_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row_inner && (row_inner_params = _.extend(row_inner_params, window.vc_settings_presets.vc_row_inner)), column_inner_params = {
                        width: "1/1"
                    }, "undefined" != typeof window.vc_settings_presets.vc_column_inner && (column_inner_params = _.extend(column_inner_params, window.vc_settings_presets.vc_column_inner)), row = vc.shortcodes.create({
            ...
            setMediaSizeClass: function() {
                ...
                modalWidth = this.$el.width(), classes = {
                    ...
                    md: !1,
                    lg: !1
                }, modalWidth >= 525 && (classes.sm = !0), modalWidth >= 745 && (classes.md = !0), modalWidth >= 945 && (classes.lg = !0), _.each(classes, function(value, key) {
            ...
            initialize: function() {
                _.bindAll(this, "setSize", "setTabsSize", "fixElContainment", "hookDependent"), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this), this.on("render", this.setTitle, this), this.on("render", this.prepareContentBlock, this)
            },
            render: function(model, not_request_template) {
                ...
                }, this), this.trigger("render"), this.$el.find('[data-vc-ui-element="settings-dropdown"]').hide(), this.show(), this.ajax = $.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: this.ajaxData(),
                    context: this
                }).done(this.buildParamsContent), this
            },
            ...
            saveSettings: function(title, is_default) {
                var shortcode_name = this.model.get("shortcode"),
                    ...
                    success = !1;
                "undefined" != typeof title && title.length && ("undefined" == typeof is_default && (is_default = !1), $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: window.ajaxurl,
                    ...
                    response.success && (success = !0, this.setSettingsMenuContent(response.html), this.settingsPresetId = response.id, is_default && (window.vc_settings_presets[shortcode_name] = this.getParamsForSettingsPreset()), this.untaintSettingsPresetData(), $button.addClass("vc_done"), setTimeout(function() {
                        $button.removeClass("vc_done")
                    }, 2e3))
                }).always(function() {
                    success || vcConsoleLog("Could not save settings preset")
                }))
            },
            ...
            fetchSaveSettingsDialog: function(callback) {
                var $dropdown = this.$el.find(this.settingsDropdownSelector),
                    success = !1;
                return $dropdown.find(".vc_ui-prompt").length ? void("undefined" != typeof callback && callback(!1)) : void $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: window.ajaxurl,
                    data: this.fetchSaveSettingsDialogAjaxData()
                }).done(function(response) {
                    response.success && (success = !0, $dropdown.append(response.html), "undefined" != typeof callback && callback(!0))
                }).always(function() {
                    success || vcConsoleLog("Could not fetch html")
                })
            },
            showSaveSettingsDialog: function(is_default) {
                ...
                this.isSettingsPresetDefault = !!is_default, this.fetchSaveSettingsDialog(function(created) {
                    ...
                    $prompt.addClass("vc_visible"), $button.prop("disabled", !0), $title.focus(), created && ($prompt.on("submit", function() {
                        var title = $title.val(),
                            $button = that.$el.find(that.settingsButtonSelector);
                        return title.length ? (that.saveSettings(title, that.isSettingsPresetDefault), $title.val(""), $prompt.removeClass("vc_visible"), $button.removeProp("disabled").click(), !1) : !1
                    }), $prompt.on("click", ".vc_ui-prompt-close", function() {
                        return $button.removeProp("disabled"), $prompt.removeClass("vc_visible"), !1
                    }))
                })
            },
            ...
            loadSettings: function(id) {
                ...
                this.panelInit = !1, $.ajax({
                    ...
                    response.success && (success = !0, this.settingsPresetId = id, this.renderSettingsPreset(response.data))
                }).always(function() {
                    success || vcConsoleLog("Could not get settings preset")
                })
            },
            ...
            deleteSettings: function(id) {
                var shortcode_name = this.model.get("shortcode"),
                    success = !1;
                confirm(window.i18nLocale.delete_preset_confirmation) && $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: window.ajaxurl,
                    ...
                    success || vcConsoleLog("Could not delete settings preset")
                })
            },
            ...
            saveAsDefaultSettings: function() {
                var shortcode_name = this.model.get("shortcode"),
                    success = !1;
                !this.settingsPresetId || this.isSettingsPresetDataTainted() ? this.showSaveSettingsDialog(!0) : $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: window.ajaxurl,
                    ...
                    response.success && (success = !0, this.setSettingsMenuContent(response.html), this.untaintSettingsPresetData(), window.vc_settings_presets[shortcode_name] = this.getParamsForSettingsPreset())
                }).always(function() {
                    success || vcConsoleLog("Could not save default settings preset")
                })
            },
            ...
            restoreDefaultSettings: function() {
                ...
                $.ajax({
                    ...
                    response.success && (success = !0, this.setSettingsMenuContent(response.html), delete window.vc_settings_presets[shortcode_name], "undefined" !== window.vc_vendor_settings_presets[shortcode_name] && (window.vc_settings_presets[shortcode_name] = window.vc_vendor_settings_presets[shortcode_name]))
                }).always(function() {
                    success || vcConsoleLog("Could not save default settings preset")
                })
            },
            setSettingsMenuContent: function(html) {
                var $button = this.$el.find(this.settingsButtonSelector),
                    ...
                    that = this;
                $button.data("vcShortcodeName", shortcode_name), $menu.html(html), $menu.find("[data-vc-load-settings-preset]").on("click", function() {
                    that.loadSettings($(this).data("vcLoadSettingsPreset")), that.closeSettings()
                    ...
                    that.showSaveSettingsDialog(), that.closeSettings()
                }), $menu.find("[data-vc-save-default-settings-preset]").on("click", function() {
                    that.saveAsDefaultSettings(), that.closeSettings()
                }), $menu.find("[data-vc-restore-default-settings-preset]").on("click", function() {
                    that.restoreDefaultSettings(), that.closeSettings()
                })
            },
            ...
            reloadSettingsMenuContent: function() {
                var shortcode_name = this.model.get("shortcode"),
                    ...
                    success = !1;
                $button.addClass("vc_loading"), this.setSettingsMenuContent(""), $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: window.ajaxurl,
                    ...
                    response.success && (success = !0, this.setSettingsMenuContent(response.html), $button.data("vcSettingsMenuLoaded", !0).removeClass("vc_loading"))
                }).always(function() {
                    success || (this.closeSettings(), vcConsoleLog("Could not fetch html"))
                })
            },
            closeSettings: function(destroy) {
                "undefined" == typeof destroy && (destroy = !1);
            ...
            renderSettingsPreset: function(params) {
                return this.currentModelParams = params, "vc_tta_section" === this.model.get("shortcode") && "undefined" != typeof params.tab_id && (params.tab_id = vc_guid() + "-cl"), this._killEditor(), this.clearButtonMessage(), this.trigger("render"), this.show(), this.ajax = $.ajax({
                    type: "POST",
                    url: window.ajaxurl,
            ...
            init: function() {
                ...
                $(".wpb_edit_form_elements .textarea_html").each(function() {
                    ...
                    $this.data("vcSettingsMenuLoaded") && shortcode_name === $this.data("vcShortcodeName") || _this.reloadSettingsMenuContent()
                }), this.panelInit = !0
            },
            initParams: function() {
                var _this = this,
            ...
            hide: function(e) {
                e && e.preventDefault(), this.ajax && this.ajax.abort(), this.ajax = !1, this.model && (this.model = null), vc.active_panel = !1, this.currentModelParams = !1, this._killEditor(), this.$el.removeClass("vc_active"), this.$el.find(".vc_properties-list").removeClass("vc_with-tabs").css("margin-top", "auto"), this.$content.empty(), this.trigger("hide")
            },
            setTitle: function() {
                return this.$el.find(".vc_panel-title").text(vc.getMapped(this.model.get("shortcode")).name + " " + window.i18nLocale.settings), this
            },
            ...
            removeTemplate: function(e) {
                ...
                answer && ($button.closest('[data-vc-ui-element="template"]').remove(), this.$list.html(window.i18nLocale.loading), $.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: {
            ...
            validateCellsList: function(cells) {
                var b, num, denom, return_cells = [],
                    ...
                    sum = _.reduce(_.map(split, function(c) {
                        ...
                        return c.match(/^[1-9]|1[0-2]\/[1-9]|1[0-2]$/) ? (b = c.split(/\//), num = parseInt(b[0], 10), denom = parseInt(b[1], 10), 0 !== 12 % denom || num > denom ? 1e3 : (return_cells.push(num + "" + b[1]), 12 * num / denom)) : 1e3
                    }), function(num, memo) {
                        return memo += num
                    }, 0);
                return sum >= 1e3 ? !1 : return_cells.join("_")
            }
        ...
        vc.HelperPanelViewHeaderFooter = {
            ...
            toggleOpacity: function(e) {
                ...
                "undefined" == typeof $target.data("vcHasHeight") && $target.data("vcHasHeight", function($element, property) {
                    var styles = $element.attr("style"),
                        hasStyle = !1;
                    return styles && styles.split(";").forEach(function(e) {
                        var style = e.split(":");
                        $.trim(style[0]) === property && (hasStyle = !0)
                    }), hasStyle
                }($target, "height")), $target.hasClass(minimizedClass) ? ("undefined" == typeof $target.data("vcMinimizeHeight") && $target.data("vcMinimizeHeight", $(window).height() - .2 * $(window).height()), $target.animate({
                    height: $target.data("vcMinimizeHeight")
                }, {
                    duration: timing,
                    start: function() {
                        $trigger.prop("disabled", !0), $target.addClass(animationClass), _this.tabsMenu && _this.tabsMenu() && _this.tabsMenu().vcTabsLine("moveTabs")
                    },
                    complete: function() {
                        $target.removeClass(minimizedClass), $target.removeClass(animationClass), $target.data("vcHasHeight") || $target.css({
                            height: ""
                    ...
                    duration: timing,
                    start: function() {
                        $trigger.prop("disabled", !0), $target.addClass(animationClass)
                    },
                    complete: function() {
                        $target.addClass(minimizedClass), $target.removeClass(animationClass), $target.css({
                                height: ""
                            }), _this.trigger("afterMinimize"),
                            $trigger.prop("disabled", !1)
                    }
                }))
            },
        ...
        "use strict";
        vc.TemplateWindowUIPanelBackendEditor = vc.TemplatesPanelViewBackend.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperTemplatesPanelViewSearch).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).extend({
        ...
        }), vc.TemplateWindowUIPanelFrontendEditor = vc.TemplatesPanelViewFrontend.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperTemplatesPanelViewSearch).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).extend({
            panelName: "template_window",
            showMessageDisabled: !1,
            show: function() {
            ...
            if (i = 0, $allTriggers = this.getContainer().find("[data-vc-preview-handler]").each(function() {
                ...
                var $triggerPanel = $this.closest(".vc_ui-list-bar-item"),
                    $wrapper = $this.closest("[data-template_unique_id]"),
        ...
        vc.element_start_index = 0, vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
            ...
            initialize: function() {
                vc.AddElementUIPanelBackendEditor.__super__.initialize.call(this), vc.events.on("shortcodes:add", this.addCustomCssStyleTag.bind(this))
            },
            render: function(model, prepend) {
            ...
            _getNotIn: _.memoize(function(tag) {
                var selector;
                return selector = _.reduce(vc.map, function(memo, shortcode) {
                    var separator;
                ...
                }, ""), '[data-vc-ui-element="add-element-button"]:not(' + selector + ")"
            }),
            filterElements: function(e) {
            ...
            createElement: function(e) {
                ...
                var model, column, row, showSettings, shortcode, row_params, column_params, tag = $(e.currentTarget).data("tag");
                row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), column_params = {
                    width: "1/1"
                }, "undefined" != typeof window.vc_settings_presets.vc_column && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column)), !1 === this.model ? (vc.storage.lock(), row = vc.shortcodes.create({
                    shortcode: "vc_row",
                    params: row_params
                }), column = vc.shortcodes.create({
                    shortcode: "vc_column",
                    ...
                    parent_id: column.id,
                    root_id: row.id
                }) : row) : "vc_row" === tag ? (row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row_inner && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row_inner)), column_params = {
                    width: "1/1"
                }, "undefined" != typeof window.vc_settings_presets.vc_column_inner && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column_inner)), vc.storage.lock(), row = vc.shortcodes.create({
                    shortcode: "vc_row_inner",
                    params: row_params,
                    parent_id: this.model.id,
                    order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder()
                    ...
                    order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder(),
                    root_id: this.model.get("root_id")
                }), this.model = model, showSettings = !(_.isBoolean(vc.getMapped(tag).show_settings_on_create) && !1 === vc.getMapped(tag).show_settings_on_create), shortcode = this.model.get("shortcode"), "undefined" != typeof window.vc_settings_presets[shortcode] && this.model.save({
                    params: _.extend({}, this.model.attributes.params, window.vc_settings_presets[shortcode])
                }), this.hide(), showSettings && this.showEditForm()
            },
            getFirstPositionIndex: function() {
                return vc.element_start_index -= 1, vc.element_start_index
            },
            ...
            createElement: function(e) {
                _.isObject(e) && e.preventDefault();
                var showSettings, params, shortcodeFirst, newData, i, shortcode, column_params, row_params, row_inner_params, $control = $(e.currentTarget),
                    tag = $control.data("tag");
                for (row_inner_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row_inner && (row_inner_params = _.extend(row_inner_params, window.vc_settings_presets.vc_row_inner)), row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), !1 === this.model && "vc_row" !== tag ? (column_params = {
                        width: "1/1"
                    }, "undefined" != typeof window.vc_settings_presets.vc_column && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column)), this.builder.create({
                        shortcode: "vc_row",
                        params: row_params
                    }).create({
                        shortcode: "vc_column",
                        parent_id: this.builder.lastID(),
                        params: column_params
                    }), this.model = this.builder.last()) : !1 !== this.model && "vc_row" === tag && (tag += "_inner"), params = {
                        shortcode: tag,
                        parent_id: this.model ? this.model.get("id") : !1
                    }, "vc_row" === tag ? params.params = row_params : "vc_row_inner" === tag && (params.params = row_inner_params), this.prepend ? (params.order = 0, shortcodeFirst = vc.shortcodes.findWhere({
                        parent_id: this.model.get("id")
                    }), shortcodeFirst && (params.order = shortcodeFirst.get("order") - 1), vc.activity = "prepend") : this.place_after_id && (params.place_after_id = this.place_after_id), this.builder.create(params), i = this.builder.models.length - 1; i >= 0; i--) shortcode = this.builder.models[i].get("shortcode"), "undefined" != typeof window.vc_settings_presets[shortcode] && (this.builder.models[i].attributes.params = _.extend(this.builder.models[i].attributes.params, window.vc_settings_presets[shortcode]));
                "vc_row" === tag ? (column_params = {
                    width: "1/1"
                }, "undefined" != typeof window.vc_settings_presets.vc_column && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column)), this.builder.create({
                    shortcode: "vc_column",
                    parent_id: this.builder.lastID(),
        ...
        vc.EditElementUIPanel = vc.EditElementPanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).extend({
            ...
            setTitle: function() {
                return this.$el.find('[data-vc-ui-element="panel-title"]').text(vc.getMapped(this.model.get("shortcode")).name + " " + i18nLocale.settings), this
            },
            tabsMenu: function() {
                if (!1 === this.tabsInit) {
                    this.tabsInit = !0;
...
if (_.extend(vc, {
        ...
        vc.map = {}, vc.setFrameSize = function(size) {
            ...
            return defaults = {}, params = _.isArray(vc.getMapped(tag).params) ? vc.getMapped(tag).params : [], _.each(params, function(param) {
                _.isObject(param) && (_.isUndefined(param.std) ? _.isUndefined(param.value) || (vc.atts[param.type] && vc.atts[param.type].defaults ? defaults[param.param_name] = vc.atts[param.type].defaults(param) : !_.isObject(param.value) || _.isArray(param.value) || _.isString(param.value) ? _.isArray(param.value) ? defaults[param.param_name] = param.value[0] : defaults[param.param_name] = param.value : defaults[param.param_name] = _.values(param.value)[0]) : defaults[param.param_name] = param.std)
            }), defaults
            ...
            return params = _.isArray(vc.getMapped(tag).params) ? vc.getMapped(tag).params : [], paramSettings = _.find(params, function(settings) {
            ...
            vc.shortcode_relevance = {}, _.each(vc.map, function(object) {
                ...
                return _.isArray(vc.shortcode_relevance["parent_only_" + tag]) && !_.contains(vc.shortcode_relevance["parent_only_" + tag], related_tag) ? !1 : _.isArray(vc.shortcode_relevance["parent_except_" + tag]) && _.contains(vc.shortcode_relevance["parent_except_" + tag], related_tag) ? !1 : _.isArray(vc.shortcode_relevance["child_only_" + related_tag]) && !_.contains(vc.shortcode_relevance["child_only_" + related_tag], tag) ? !1 : _.isArray(vc.shortcode_relevance["child_except_" + related_tag]) && _.contains(vc.shortcode_relevance["child_except" + related_tag], tag) ? !1 : !0
            }
            ...
            return mod > 0 && is_odd(column) && column % 3 ? column + "/12" : (0 === mod && (mod = column), column / mod + "/" + 12 / mod)
            ...
            render: function() {
                ...
                this.$el.attr("data-tag", tag), this.$el.addClass("vc_" + tag), this.addControls();
                var is_container = _.isObject(vc.getMapped(tag)) && (_.isBoolean(vc.getMapped(tag).is_container) && !0 === vc.getMapped(tag).is_container || !_.isEmpty(vc.getMapped(tag).as_parent));
                return is_container && this.$el.addClass("vc_container-block"), this.changed(), this
            },
            checkControlsPosition: function() {
                if (this.$controls_buttons) {
                    var window_top, control_top, element_position_top, new_position, element_height = this.$el.height(),
                        frame_height = vc.$frame.height();
                    element_height > frame_height && (window_top = $(vc.frame_window).scrollTop(), control_top = this.$controls_buttons.offset().top, element_position_top = this.$el.offset().top, new_position = window_top - element_position_top + vc.$frame.height() / 2, new_position > 40 && element_height > new_position ? this.$controls_buttons.css("top", new_position) : new_position > element_height ? this.$controls_buttons.css("top", element_height - 40) : this.$controls_buttons.css("top", 40))
                }
            },
            ...
            addControls: function() {
                ...
                var compiledTemplate = vc.template(template, _.extend({}, vc.templateOptions.custom, {
                    evaluate: /\{#([\s\S]+?)#}/g
                }));
            ...
            changeParentId: function() {
                ...
                vc.builder.notifyParent(this.model.get("parent_id")), !1 === parent_id ? app.placeElement(this.$el) : (parent = vc.shortcodes.get(parent_id), parent && parent.view && parent.view.placeElement(this.$el)), this.parentChanged()
            },
            ...
            destroy: function(e) {
                ...
                var answer = confirm(window.i18nLocale.press_ok_to_delete_section);
                return !0 !== answer ? !1 : (vc.showMessage(window.sprintf(window.i18nLocale.inline_element_deleted, this.model.setting("name"))), void this.model.destroy())
            },
            ...
            placeElement: function($view, activity) {
                ...
                model && model.get("place_after_id") ? ($view.insertAfter(vc.$page.find("[data-model-id=" + model.get("place_after_id") + "]")), model.unset("place_after_id")) : _.isString(activity) && "prepend" === activity ? $view.prependTo(this.content()) : $view.appendTo(this.content()), this.changed()
            }
            ...
            updateKeyPress: function(e) {
                return 13 === e.which ? (e.preventDefault(), vc.$title.attr("contenteditable", !1), $(".entry-content").trigger("click"), !1) : void 0
            },
            loadDefaultTemplate: function(e) {
            ...
            addTextBlock: function(e) {
                ...
                e.preventDefault(), row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), column_params = {
                    width: "1/1"
            ...
            initialize: function() {
                _.bindAll(this, "saveRowOrder", "saveElementOrder", "saveColumnOrder", "resizeWindow"), vc.shortcodes.on("change:params", this.changeParamsEvents, this), vc.events.on("shortcodes:add", vcAddShortcodeDefaultParams, this), vc.events.on("shortcodes:add", vc.atts.addShortcodeIdParam, this)
            },
            ...
            resizeFrame: function(e) {
                var $control = $(e.currentTarget);
                return e.preventDefault(), $control.hasClass("active") ? !1 : (this.$size_control.find(".active").removeClass("active"), $("#vc_screen-size-current").attr("class", "vc_icon " + $control.attr("class")), this.current_size = $control.data("size"), $control.addClass("active"), void vc.setFrameSize(this.current_size))
            },
            ...
            createRow: function(e) {
                ...
                row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), column_params = {
                    width: "1/1"
                }, "undefined" != typeof window.vc_settings_presets.vc_column && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column)), builder.create({
                    shortcode: "vc_row",
                    params: row_params
                }).create({
                    shortcode: "vc_column",
            ...
            saveRowOrder: function() {
                _.defer(function(app) {
                    var row_params, column_params, $rows = vc.$page.find("> [data-tag=vc_row]"),
                    ...
                    $rows.each(function(key, value) {
                        ...
                        if ($this.is(".droppable")) {
                            row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), column_params = {
                                width: "1/1"
                            }, "undefined" != typeof window.vc_settings_presets.vc_column && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column)), $this.remove();
                            var row_data = {
                                shortcode: "vc_row",
                                params: row_params,
                                order: key
                        ...
                        } else vc.shortcodes.get($this.data("modelId")).save({
                            order: key
                        }, {
                            silent: !0
                        })
        ...
        function TTaMapChildEvents(model) {
            ...
            vc.events.on("shortcodes:" + childTag + ":add:parent:" + model.get("id"), function(model) {
                var activeTabIndex, models, parentModel;
                return parentModel = vc.shortcodes.get(model.get("parent_id")), activeTabIndex = parseInt(parentModel.getParam("active_section")), "undefined" == typeof activeTabIndex && (activeTabIndex = 1), models = _.pluck(_.sortBy(vc.shortcodes.where({
                    parent_id: parentModel.get("id")
                }), function(model) {
                    return model.get("order")
                }), "id"), models.indexOf(model.get("id")) === activeTabIndex - 1 && model.set("isActiveSection", !0), model
            }), vc.events.on("shortcodes:" + childTag + ":clone:parent:" + model.get("id"), function(model) {
                vc.ttaSectionActivateOnClone && model.set("isActiveSection", !0), vc.ttaSectionActivateOnClone = !1
            })
        }
        _.isUndefined(window.vc) && (window.vc = {}), window.InlineShortcodeViewContainer = window.InlineShortcodeView.extend({
            ...
            hold_active: !1,
            initialize: function(params) {
                _.bindAll(this, "holdActive"), window.InlineShortcodeViewContainer.__super__.initialize.call(this, params), this.parent_view = vc.shortcodes.get(this.model.get("parent_id")).view
            },
            ...
            addControls: function() {
                ...
                shortcodeTag = this.model.get("shortcode"), template = $(this.controls_selector).html(), parent = vc.shortcodes.get(this.model.get("parent_id")), parentShortcodeTag = parent.get("shortcode"), allAccess = vc_user_access().shortcodeAll(shortcodeTag), editAccess = vc_user_access().shortcodeEdit(shortcodeTag), parentAllAccess = vc_user_access().shortcodeAll(parentShortcodeTag), parentEditAccess = vc_user_access().shortcodeEdit(parentShortcodeTag), data = {
                    name: vc.getMapped(shortcodeTag).name,
                    tag: shortcodeTag,
            ...
            convertRowColumns: function(layout, builder) {
                ...
                return vc.layout_change_shortcodes = [], vc.layout_old_columns = vc.shortcodes.where({
                    ...
                    _.isObject(prev_settings) ? (new_model = builder.create({
                        ...
                        width: column
                    }, "undefined" != typeof window.vc_settings_presets[this.column_tag] && (column_params = _.extend(column_params, window.vc_settings_presets[this.column_tag])), new_model = builder.create({
                        shortcode: this.column_tag,
                        parent_id: this.model.get("id"),
                        order: vc.shortcodes.nextOrder(),
                        params: column_params
            ...
            customCssClassReplace: function() {
                ...
                css_classes = this.$el.find(".wpb_column").attr("class"), css_regex = /.*(vc_custom_\d+).*/, class_match = css_classes && css_classes.match ? css_classes.match(css_regex) : !1, class_match && class_match[1] && (this.$el.addClass(class_match[1]), this.$el.find(".wpb_column").attr("class", css_classes.replace(class_match[1], "").trim()))
            },
            ...
            resize: function(e) {
                ...
                diff = e.pageX - this._x, Math.abs(diff) < this._grid_step || (this._x = parseInt(e.pageX), old_width = "" + this.css_class_width, diff > 0 ? this.css_class_width += 1 : 0 > diff && (this.css_class_width -= 1), 12 < this.css_class_width && (this.css_class_width = 12), 1 > this.css_class_width && (this.css_class_width = 1), params.width = vc.getColumnSize(this.css_class_width), this.model.save({
                    params: params
                }, {
                    silent: !0
        ...
        }), window.InlineShortcodeView_vc_column_inner = window.InlineShortcodeView_vc_column.extend({}), window.InlineShortcodeView_vc_tabs = window.InlineShortcodeView_vc_row.extend({
            events: {
            ...
            addTab: function(model) {
                ...
                var $cloned_tab, $control = this.buildControlHtml(model);
                return model.get("cloned") && ($cloned_tab = this.tabsControls().find("[data-m-id=" + model.get("cloned_from").id + "]")).length ? model.get("cloned_appended") || ($control.appendTo(this.tabsControls()), model.set("cloned_appended", !0)) : $control.appendTo(this.tabsControls()), this.changed(), !0
            },
            ...
            updateIfExistTab: function(model) {
                ...
                return $tab.length ? ($tab.attr("aria-controls", "tab-" + model.getParam("tab_id")).find("a").attr("href", "#tab-" + model.getParam("tab_id")).text(model.getParam("title")), !0) : !1
            },
            ...
            doSetAsActive: function() {
                ...
                return (this.model.get("from_content") || this.model.get("default_content") || !_.isUndefined(active_before_cloned)) && (_.isUndefined(active_before_cloned) || (this.model.unset("active_before_cloned"), !0 !== active_before_cloned)) ? !1 : this.model
            },
            removeView: function(model) {
            ...
            render: function() {
                return window.InlineShortcodeView_vc_tab.__super__.render.call(this), this.content().find(".vc_element[data-tag]").length || this.content().empty(), this.parent_view.buildAccordion(this.model.get("from_content") || this.model.get("default_content") ? !1 : this.model), this
            },
            rowsColumnsConverted: function() {
                _.each(vc.shortcodes.where({
                    parent_id: this.model.get("id")
            ...
            render: function() {
                ...
                return window.InlineShortcodeView_vc_single_image.__super__.render.call(this), vc.frame_window.vc_iframe.addActivity(function() {
                    "undefined" != typeof this.vc_image_zoom && this.vc_image_zoom(model_id)
                }), this
            },
            parentChanged: function() {
                var modelId = this.model.get("id");
                return window.InlineShortcodeView_vc_single_image.__super__.parentChanged.call(this), "undefined" != typeof vc.frame_window.vc_image_zoom && _.defer(function() {
        ...
        }), window.InlineShortcodeView_vc_carousel = window.InlineShortcodeView_vc_images_carousel.extend({}), window.InlineShortcodeView_vc_gallery = window.InlineShortcodeView.extend({
            render: function() {
                var model_id = this.model.get("id");
            ...
            initGridJs: function(useAddActivity) {
                ...
                return !0 === model.get("grid_activity") ? !1 : (model.set("grid_activity", !0), void(!0 === useAddActivity ? vc.frame_window.vc_iframe.addActivity(function() {
            ...
            render: function() {
                return window.InlineShortcodeViewContainer.__super__.render.call(this), _.bindAll(this, "buildSortable", "updateSorting"), this.content(), this.buildPagination(), this
            },
            addControls: function() {
                return this.$controls = $('<div class="no-controls"></div>'), this.$controls.appendTo(this.$el), this
            },
            ...
            buildSortable: function() {
                this.$el && this.$el.find(".vc_tta-panels").sortable({
            ...
            parentChanged: function() {
                window.InlineShortcodeView_vc_tta_accordion.__super__.parentChanged.call(this), "undefined" != typeof vc.frame_window.vc_round_charts && vc.frame_window.vc_round_charts(this.model.get("id")), "undefined" != typeof vc.frame_window.vc_line_charts && vc.frame_window.vc_line_charts(this.model.get("id"))
            },
            ...
            getPaginationList: function() {
                ...
                return params = this.model.get("params"), !_.isUndefined(params.pagination_style) && params.pagination_style.length ? ($accordions = this.$el.find("[data-vc-accordion]"), classes = [], classes.push("vc_general"), classes.push("vc_pagination"), styleChunks = params.pagination_style.split("-"), classes.push("vc_pagination-style-" + styleChunks[0]), classes.push("vc_pagination-shape-" + styleChunks[1]), !_.isUndefined(params.pagination_color) && params.pagination_color.length && classes.push("vc_pagination-color-" + params.pagination_color), html = [], html.push('<ul class="' + classes.join(" ") + '">'), that = this, $accordions.each(function() {
            ...
            sectionUpdated: function(model, justAppend) {
                ...
                if (tabAdded = !1, sectionId = model.get("id"), $navigation = this.$el.find(".vc_tta-tabs-container .vc_tta-tabs-list"), $tabEl = $navigation.find('[data-vc-target="[data-model-id=' + sectionId + ']"]'), title = model.getParam("title"), $tabEl.length) html = '<span class="vc_tta-title-text">' + title + "</span>", html = this.addIcon(model, html), $tabEl.html(html);
                    ...
                    }), "id"), index = models.indexOf(model.get("id")) - 1, index > -1 && $navigation.find("[data-vc-tab]:eq(" + index + ")").length && ($element.insertAfter($navigation.find("[data-vc-tab]:eq(" + index + ")")), tabAdded = !0)), !tabAdded && $element.appendTo($navigation), model.get("isActiveSection") && $element.addClass(this.activeClass)
                }
                this.buildPagination()
            },
            getNextTab: function($viewTab) {
                var lastIndex, viewTabIndex, $nextTab, $navigationSections;
                return $navigationSections = this.$el.find(".vc_tta-tabs-container .vc_tta-tabs-list").children(), lastIndex = $navigationSections.length - 1, viewTabIndex = $viewTab.index(), $nextTab = viewTabIndex !== lastIndex ? $navigationSections.eq(viewTabIndex + 1) : $navigationSections.eq(viewTabIndex - 1)
            },
        ...
        }), window.InlineShortcodeView_vc_tta_pageable = window.InlineShortcodeView_vc_tta_tour.extend({}), vc.ttaSectionActivateOnClone = !1, window.InlineShortcodeView_vc_tta_section = window.InlineShortcodeViewContainerWithParent.extend({
            events: {
        ...
        }), vc.events.on("shortcodes:vc_tta_accordion:add", TTaMapChildEvents), vc.events.on("shortcodes:vc_tta_tabs:add", TTaMapChildEvents), vc.events.on("shortcodes:vc_tta_tour:add", TTaMapChildEvents), vc.events.on("shortcodes:vc_tta_pageable:add", TTaMapChildEvents), vc.events.on("shortcodeView:updated", function(model) {
            ...
            }), window.InlineShortcodeView_gmap_advanced =
            window.InlineShortcodeView.extend({
                render: function() {
                    var model_id = this.model.get("id");
                    return window.InlineShortcodeView_gmap_advanced.__super__.render.call(this), vc.frame_window.vc_iframe.addActivity(function() {
                ...
                render: function() {
                    var model_id = this.model.get("id");
                    return window.InlineShortcodeView_vc_counter.__super__.render.call(this),
                        vc.frame_window.vc_iframe.addActivity(function() {
                            this.vc_iframe.vc_counter(model_id)
                        }), this
                }
            }), window.InlineShortcodeView_countdown_el = window.InlineShortcodeView.extend({
                render: function() {
                    var model_id = this.model.get("id");
...
! function($) {
    ...
    vc.createPreLoader = function() {
        ...
        if (!vc.loaded) {
            ...
            }), vc.app.render(), vc.post_shortcodes = vc.frame_window.vc_post_shortcodes, vc.builder.buildFromContent(), vc.removePreLoader(), $(window).trigger("vc_build")
        }
...
! function($) {
    ...
    vcPointersController = function(Pointer, texts) {
        ...
        build: function() {
            return this.pointer = this.getPointer(this._index), vc.events.once("backendEditor.close", this.close, this), this.pointer ? void this.setShowEventHandler() : !1
        },
        show: function() {
        ...
        dismissMessages: function() {
            return this.messagesDismissed ? !1 : ($.post(window.ajaxurl, {
                pointer: this.pointerId,
                action: "dismiss-wp-pointer"
            }), void(this.messagesDismissed = !0))
        }
    }
}(window.jQuery),
function($) {
