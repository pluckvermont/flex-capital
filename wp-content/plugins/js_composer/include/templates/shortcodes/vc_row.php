 ...
 */
$el_class = $full_height = $parallax_speed_bg = $parallax_speed_video = $full_width = $layout = $equal_height = $flex_row = $columns_placement = $content_placement = $parallax = $parallax_image = $css = $el_id = $section_id = $video_bg = $video_bg_url = $video_bg_render = $video_bg_parallax = '';
$disable_element = '';
$output = $after_output = '';
...
if ( ! empty( $parallax ) ) {
	$wrapper_attributes[] = 'data-stellar-background-ratio="0.5" style="background-size: cover; background-attachment:fixed;"';
