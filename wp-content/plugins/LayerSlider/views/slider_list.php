		...
		<div class="ls-auto-update active"><!--
			...
			<form method="post" class="ls-box km-tabs-inner ls-settings">
				...
				<div class="inner">
					...
					<p style="color:red">
						<?php _e("It seems you've received LayerSlider by a theme. Please note that the auto-update feature only works if you've purchased the plugin directly from us on <a href=\"http://codecanyon.net/item/layerslider-responsive-wordpress-slider-plugin-/1362246\" target=\"_blank\">CodeCanyon</a>. <br> The plugin will be updated from the Theme provider, directly on future theme updates!", "LayerSlider"); ?>
					</p>
					<?php endif ?>
				</div>
